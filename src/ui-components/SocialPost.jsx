        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="HUEntrepenuer Network - BasementBoy"
              {...getOverrideProps(
                overrides,
                "HUEntrepenuer Network - BasementBoy"
              )}
            ></Text>
            <Flex
              gap="16px"
          ...
          >
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children=" I really loved the clothes that I was able to purchase from this brand. It was amazing quality, really thick, and I loved the way it fit on me . 10/10 would recommend to all of my friends!"
              {...getOverrideProps(
                overrides,
                "I really loved the clothes that I was able to purchase from this brand. It was amazing quality, really thick, and I loved the way it fit on me . 10/10 would recommend to all of my friends!"
              )}
            ></Text>
          </Flex>
          <Flex
