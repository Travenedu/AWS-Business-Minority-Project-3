        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="CROCHET Queens - Purple knit dress"
              {...getOverrideProps(
                overrides,
                "CROCHET Queens - Purple knit dress"
              )}
            ></Text>
            <Text
              fontFamily="Inter"
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Crochet queens brings life and style to everyday pieces. We are able to"
              {...getOverrideProps(
                overrides,
                "Crochet queens brings life and style to everyday pieces. We are able to"
              )}
            ></Text>
          </Flex>
          <Divider
