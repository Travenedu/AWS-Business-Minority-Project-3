...
export const TypeEdit = ({ className }) => {
  return (
    <svg
      className={`type-edit ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
